...
sn_sus_chain <- array(NA,dim = c(tot_iter,n_sex,n_agef,n_year))

  ##sex,age,year
for (k in 1:tot_iter) {
  sn_sus_chain[k,,,] <- calc_surv_aah(
      nT_age = nT_age_surv,
...
sn_inf_chain <- array(NA,dim = c(tot_iter,n_sex,n_agef,n_year))
  ##sex,age,year
for (k in 1:tot_iter) {
  sn_inf_chain[k,,,] <- calc_surv_aah(
      nT_age = nT_age_surv,
      nT_period = nT_period_collar,
      nT_age_short_f = nT_age_short_f,
      nT_age_short_m = nT_age_short_m,
